...
//using static ACS.WebApi.Controllers.ADAuthenticationController;
...
using static UserApiService.Controllers.ADAuthenticationController;
...
namespace UserApiService.Services
{
    public class AzureAuthenticationService
    {
        ...
        {
            Console.WriteLine("CODUL ESTE " + code);
